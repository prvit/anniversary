angular.module('anniversary.component.grid-isotope')
...
).directive('anniversaryGridIsolate', function (preloader) {
        return {
            restrict: 'E',
            scope: {
                config: '='
            ...
            link: function (scope, element) {
                ...
                var imageLocations = _.map(scope.config.elements, function (element) {
